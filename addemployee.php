							...
							<div class="collapse navbar-collapse" id="navbarSupportedContent">
								<ul class="navbar-nav mr-auto">
									<li class="nav-item active">
										<a class="nav-link" href="viewemployee.php">Water purified water refilling station <span class="sr-only">(current)</span></a>
									</li>
								</ul>
...
if(isset($_POST['Submit'])) {	
	...
	$result = mysqli_query($db, "INSERT INTO employee(id, firstname, surname, position, login_id) VALUES('$id', '$firstname', '$surname', '$position', '$loginId')");
		header('location: viewemployee.php');
	} 
?>
<div class="container">
	<form action="addemployee.php" method="post" name="form1">
		...
		<div class="form-group row">
			<label for="colFormLabel" class="col-sm-2 col-form-label"></label>
				<div class="col-sm-5">
					<button class="btn btn-outline-warningbtn btn-sm btn-outline-info" type="submit" name="Submit" value="Add">Save employee</button>
